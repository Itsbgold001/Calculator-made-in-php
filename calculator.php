...
<body>
<div class="blog-form">Calculator</div><div class="blog-form">
...
input[type=number],input[type=u],textarea{border-radius:6px;background:#fff; color:#808080;border:1px solid #c0c0c0;padding:10px;width:200px;-o-box-shadow:      12px 12px 29px #555;
